...
<!-- ABOUT THE PROJECT -->
## About The Project
This is a probabilistic displacement hazard framework for immature strike-slip faults. I maintain this project for minor bug fixes and additional model application development. The version of this framework applied in Rodriguez Padilla and Oskin (2023, BSSA) is stored in Zenodo repository [https://zenodo.org/records/13892098](https://zenodo.org/records/1389209), created Oct 4, 2024, and is release v1. 
