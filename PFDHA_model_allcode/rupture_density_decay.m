...
main_rupture = shaperead('HectorMine_main_rupture.shp'); % load main trace shapefile 
str = 'HectorMine_density_decay.txt';

%% load high-resolution fracture map

lines_secondary = shaperead('HectorMine_secondary_fractures.shp'); % load fracture shapefile
